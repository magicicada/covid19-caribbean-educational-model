...
household_size_distribution = {'first':{7:1.0}, 'upper':{10: 0.25, 7:0.5, 5:0.25}}
number_activity_groups= 5000
activity_size_distribution={'first':{10:0.5, 5:0.5}, 'upper':{40: 0.05, 10:0.3, 5:0.5, 3: 0.15}}
